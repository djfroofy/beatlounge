...
def bpm_space_to_time(bpm, space):
    """
    This takes bpm and a magic string ("8trip", "16th", "8th", "qtrup",
    "quarter", "half", "whole") for space returns the number of seconds that
    space takes.

    For example, bpm_space_to_time(60, "quarter") = 1 ie, 1 quarter note at
    60bpm takes 1 second.
    """
    spaces = {
        '8trip': 1 / 6.,
        '16th': 1 / 4.,
