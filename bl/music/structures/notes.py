...
# Dominant 11th
C11 = [
    [C[i], E[i], G[i], Bf[i], D[i + 1], F[i + 1]] for i in range(len(C) - 2)]
# Dominant 13th
C13 = [
    [C[i], E[i], G[i], Bf[i], D[i + 1], F[i + 1], A[i + 1]]
...
# Major 11th
Cmaj11 = [
    [C[i], E[i], G[i], B[i], D[i + 1], F[i + 1]] for i in range(len(C) - 2)]
# Major 13th
Cmaj13 = [
    [C[i], E[i], G[i], B[i], D[i + 1], F[i + 1], A[i + 1]]
    for i in range(len(C) - 2)]
# Minor 9th
Cmin9 = [[C[i], Ef[i], G[i], Bf[i], D[i + 1]] for i in range(len(C) - 2)]
# Minor 11th
Cmin11 = [
    [C[i], Ef[i], G[i], Bf[i], D[i + 1], F[i + 1]] for i in range(len(C) - 2)]
# Minor 13th
Cmin13 = [
    [C[i], Ef[i], G[i], Bf[i], D[i + 1], F[i + 1], A[i + 1]]
    for i in range(len(C) - 2)]
...
chord_choices = [
    A11, A13, A9, AM7s5, Aaug, Aaug7, Adim, Adim7, Adom7, Af11, Af13, Af9,
    AfM7s5, Afaug, Afaug7, Afdim, Afdim7, Afdom7, Afm7f5, AfmM7, Afmaj,
    Afmaj11, Afmaj13, Afmaj7, Afmaj9, Afmin, Afmin11, Afmin13, Afmin7, Afmin9,
    Afsus2, Afsus4, Am7f5, AmM7, Amaj, Amaj11, Amaj13, Amaj7, Amaj9, Amin,
    Amin11, Amin13, Amin7, Amin9, As11, As13, As9, AsM7s5, Asaug, Asaug7,
    Asdim, Asdim7, Asdom7, Asm7f5, AsmM7, Asmaj, Asmaj11, Asmaj13, Asmaj7,
    Asmaj9, Asmin, Asmin11, Asmin13, Asmin7, Asmin9, Assus2, Assus4, Asus2,
    Asus4, B11, B13, B9, BM7s5, Baug, Baug7, Bdim, Bdim7, Bdom7, Bf11, Bf13,
    Bf9, BfM7s5, Bfaug, Bfaug7, Bfdim, Bfdim7, Bfdom7, Bfm7f5, BfmM7, Bfmaj,
    Bfmaj11, Bfmaj13, Bfmaj7, Bfmaj9, Bfmin, Bfmin11, Bfmin13, Bfmin7, Bfmin9,
    Bfsus2, Bfsus4, Bm7f5, BmM7, Bmaj, Bmaj11, Bmaj13, Bmaj7, Bmaj9, Bmin,
    Bmin11, Bmin13, Bmin7, Bmin9, Bsus2, Bsus4, C11, C13, C9, CM7s5, Caug,
    Caug7, Cdim, Cdim7, Cdom7, Cm7f5, CmM7, Cmaj, Cmaj11, Cmaj13, Cmaj7, Cmaj9,
    Cmin, Cmin11, Cmin13, Cmin7, Cmin9, Cs11, Cs13, Cs9, CsM7s5, Csaug, Csaug7,
    Csdim, Csdim7, Csdom7, Csm7f5, CsmM7, Csmaj, Csmaj11, Csmaj13, Csmaj7,
    Csmaj9, Csmin, Csmin11, Csmin13, Csmin7, Csmin9, Cssus2, Cssus4, Csus2,
    Csus4, D11, D13, D9, DM7s5, Daug, Daug7, Ddim, Ddim7, Ddom7, Df11, Df13,
    Df9, DfM7s5, Dfaug, Dfaug7, Dfdim, Dfdim7, Dfdom7, Dfm7f5, DfmM7, Dfmaj,
    Dfmaj11, Dfmaj13, Dfmaj7, Dfmaj9, Dfmin, Dfmin11, Dfmin13, Dfmin7, Dfmin9,
    Dfsus2, Dfsus4, Dm7f5, DmM7, Dmaj, Dmaj11, Dmaj13, Dmaj7, Dmaj9, Dmin,
    Dmin11, Dmin13, Dmin7, Dmin9, Ds11, Ds13, Ds9, DsM7s5, Dsaug, Dsaug7,
    Dsdim, Dsdim7, Dsdom7, Dsm7f5, DsmM7, Dsmaj, Dsmaj11,
    Dsmaj13, Dsmaj7, Dsmaj9, Dsmin, Dsmin11, Dsmin13, Dsmin7, Dsmin9, Dssus2,
    Dssus4, Dsus2, Dsus4, E11, E13, E9, EM7s5, Eaug, Eaug7, Edim, Edim7,
    Edom7, Ef11, Ef13, Ef9, EfM7s5, Efaug, Efaug7, Efdim, Efdim7, Efdom7,
    Efm7f5, EfmM7, Efmaj, Efmaj11, Efmaj13, Efmaj7, Efmaj9, Efmin, Efmin11,
    Efmin13, Efmin7, Efmin9, Efsus2, Efsus4, Em7f5, EmM7, Emaj, Emaj11, Emaj13,
    Emaj7, Emaj9, Emin, Emin11, Emin13, Emin7, Emin9, Esus2, Esus4, F11, F13,
    F9, FM7s5, Faug, Faug7, Fdim, Fdim7, Fdom7, Fm7f5, FmM7, Fmaj, Fmaj11,
    Fmaj13, Fmaj7, Fmaj9, Fmin, Fmin11, Fmin13, Fmin7, Fmin9, Fs11, Fs13, Fs9,
    FsM7s5, Fsaug, Fsaug7, Fsdim, Fsdim7, Fsdom7, Fsm7f5, FsmM7, Fsmaj,
    Fsmaj11, Fsmaj13, Fsmaj7, Fsmaj9, Fsmin, Fsmin11, Fsmin13, Fsmin7, Fsmin9,
    Fssus2, Fssus4, Fsus2, Fsus4, G11, G13, G9, GM7s5, Gaug, Gaug7, Gdim,
    Gdim7, Gdom7, Gf11, Gf13, Gf9, GfM7s5, Gfaug, Gfaug7, Gfdim, Gfdim7,
    Gfdom7, Gfm7f5, GfmM7, Gfmaj, Gfmaj11, Gfmaj13, Gfmaj7, Gfmaj9, Gfmin,
    Gfmin11, Gfmin13, Gfmin7, Gfmin9, Gfsus2, Gfsus4, Gm7f5, GmM7, Gmaj,
    Gmaj11, Gmaj13, Gmaj7, Gmaj9, Gmin, Gmin11, Gmin13, Gmin7, Gmin9, Gs11,
    Gs13, Gs9, GsM7s5, Gsaug, Gsaug7, Gsdim, Gsdim7, Gsdom7, Gsm7f5, GsmM7,
    Gsmaj, Gsmaj11, Gsmaj13, Gsmaj7, Gsmaj9, Gsmin, Gsmin11, Gsmin13, Gsmin7,
    Gsmin9, Gssus2, Gssus4, Gsus2, Gsus4
]
...
byzantine = hungarian = egyptian = [  # who named these?
                            C[0], D[0], Ef[0], Fs[0], G[0], Af[0], B[0]]
...
def getChordsFromNote(note="C"):
    ...
    for candidate in chord_choices:
        if any(
            [n in flattenLists(candidate) for n in getattr(bl.notes, note)]
        ):
...
scale_strings = (
    "majorpenta", "minorpenta", "suspenta", "mangong", "ritusen", "insen",
    "hirajoshi", "iwato", "kumoi", "wholetone", "augmented", "prometheus",
    "blues", "tritone", "tstritone", "major", "melodic", "dorian", "aeolian",
    "mixolydian", "lydian", "byzantine", "phrygian", "phrygianDominant",
    "locrian", "arabic"
)
...
def getScalesKeysFromNote(note="C"):
    ...
    for scale_string in scale_strings:
        scale = getattr(bl.notes, scale_string)
        for key in key_strings:
            scale = keyScale(scale, key)
            if any([n in scale for n in getattr(bl.notes, note)]):
                scale_keys.append((scale_string, key))
    return scale_keys

twelve_tone_equal_440 = [
    440 * (2 ** (i / Decimal(12))) for i in range(-57, 71)
]
...
def freqForNote(note="C"):
    import bl
    freqs = []
    for n in getattr(bl.notes, note):
